...
import FilterToolbar from './FilterToolbar'; // 👈 se importa la barra de filtros
  ...
  const filteredPersonnel = useMemo(() => {
    return (persons || []).filter((p) => {
      ...
      const matchDepartment =
        !filters.department || p.departamento === filters.department;

      const matchStatus =
        !filters.status || p.estado === filters.status;

      const matchPosition =
        !filters.position || p.puesto === filters.position;
