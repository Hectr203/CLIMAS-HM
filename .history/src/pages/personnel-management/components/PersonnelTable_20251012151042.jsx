 ...
 * ✅ Ahora recibe `personnel` filtrado desde PersonnelManagement
 * ✅ Ya no llama a usePerson() para evitar duplicación y conflictos
 */
const PersonnelTable = ({ personnel = [], onViewProfile, onEditPersonnel, onAssignPPE, loading, error }) => {
