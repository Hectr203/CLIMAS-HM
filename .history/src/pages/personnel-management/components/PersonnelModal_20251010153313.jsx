...
const PersonnelModal = ({ isOpen, onClose, employee, mode, onSave }) => {
  ...
  const { createPerson, loading } = usePerson();
...
const handleSave = async () => {
  try {
    ...
    // Llamar al hook para crear el empleado
    ...
    alert("Hubo un error al guardar el empleado. Revisa la consola para más detalles.");
  }
};
