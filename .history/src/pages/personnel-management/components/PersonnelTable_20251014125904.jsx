...
{totalPages > 1 && (
  <div className="flex flex-wrap justify-center items-center gap-2 p-4 border-t border-border">
    <Button
      variant="outline"
      size="sm"
      disabled={currentPage === 1}
      onClick={() => handlePageChange(currentPage - 1)}
      className="w-10 sm:w-auto" // ancho fijo en móviles
    >
      <Icon name="ChevronLeft" size={14} />
    </Button>

    <span className="text-sm text-muted-foreground w-full sm:w-auto text-center">
