...
const ClientManagement = () => {
  ...
  if (response && response.success) {
    await getClients(); // <-- vuelve a traer los clientes actualizados
  ...
  // Si la creación fue exitosa, recarga la lista
  if (response && response.success) {
    await getClients(); // <-- actualiza la tabla sin recargar la página
