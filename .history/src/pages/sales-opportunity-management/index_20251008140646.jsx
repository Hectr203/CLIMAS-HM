    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
      {salesStages.map((stage) => (
        ...
        >
          ...
          {/* Contenido scrollable dentro del cuadro */}
          <div
            className="flex-1 p-4 space-y-3 bg-gray-50 overflow-y-auto max-h-[75vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
          >
