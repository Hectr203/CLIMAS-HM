      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarCollapsed ? 'ml-16' : 'ml-60'}`}>
        ...
        <div className="pt-16">
          <div className="container mx-auto px-4 py-8">
            ...
            <div className={`flex gap-6 relative transition-all duration-300 ${showControls ? 'pr-[26rem]' : ''}`}>
  {/* Kanban Board con scroll unificado */}
  <div className="flex-1 h-[calc(100vh-6rem)] overflow-y-auto overflow-x-auto pb-6">
    <div className="min-w-[1000px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 pr-4">
      {salesStages.map((stage) => (
        ...
        >
          ...
          {/* Contenido (tarjetas) sin scroll interno */}
   ...
   {/* Panel lateral (fijo, sin scroll del tablero) */}
  {showControls && (
