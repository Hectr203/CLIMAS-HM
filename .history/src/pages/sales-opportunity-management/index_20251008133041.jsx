        ...
        <div className="pt-16">
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6 relative">
              {/* Main Kanban Board */}
              <div
                className={`flex-1 transition-all duration-300 ${showControls ? 'lg:pr-[26rem]' : ''}`}
              >
              ...
              {/* Controls Panel - Responsive + Animado */}
              <AnimatePresence>
                {showControls && (
                  <>
                    {/* Overlay (visible solo en pantallas small) */}
                    <motion.div
                    ...
                    <motion.div
                      ...
                      className="
                        ...
                        w-full max-w-md lg:max-w-[26rem] lg:right-16 lg:static lg:inset-auto
                        bg-card rounded-t-2xl lg:rounded-lg shadow-xl lg:shadow-lg border
                        overflow-y-auto transition-all duration-300
                      "
                      style={{ right: sidebarCollapsed ? '4rem' : undefined }}
                    >
